...
import { Home, Coffee, Calendar, Building } from 'lucide-react';
...
export function BottomNav() {
  ...
  const navItems = [
    ...
    { to: "/menu", icon: Coffee, label: "Menü" },
    { to: "/events", icon: Calendar, label: "Events" },
    { to: "/booking", icon: Building, label: "Buchen" },
  ];
